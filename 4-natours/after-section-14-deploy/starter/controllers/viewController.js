...
exports.alert = (req,res,next) => {
    ...
    if(alert==='booking')
        res.locals.alert = 'Your booking was successful!. Please check email for a confirmation. If your booking doesn\'t show up here immediately. Please come back later.'
