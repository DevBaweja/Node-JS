...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGV2YmF3ZWphIiwiYSI6ImNrYWoybXQ2MzA2b3Iyc281M25zcW1sdzMifQ.X8SF6_QRE840cxVbcrI4aQ';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            urllink = type === 'password' ? 'updateMyPassword' : 'updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3000/api/v1/users/".concat(urllink),
              data: data
            });
...
var stripe = Stripe('pk_test_KtdmGOpnmRXdWUk5DZ1sPl8h00TyLD4Xmx');
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {
      var passwordCurrent, password, passwordConfirm, status;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
